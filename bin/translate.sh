...
dart --packages=.dart_tool/package_config.json package:portal/shared/localizations/l10n/cli/untranslated_keys_clean.dart
...
dart --packages=.dart_tool/package_config.json package:portal/shared/localizations/l10n/cli/resource_untranslate_key_injector.dart
