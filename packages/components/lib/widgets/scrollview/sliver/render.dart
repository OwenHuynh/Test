    ...
    if (child != null && geometry!.visible) {
      switch (applyGrowthDirectionToAxisDirection(
        ...
        case AxisDirection.down:
          newOffset += Offset(0, childMainAxisPosition(child));
          break;
        ...
        case AxisDirection.right:
          newOffset += Offset(childMainAxisPosition(child), 0);
          break;
      }
  ...
  void setChildParentData(RenderObject child, SliverConstraints constraints,
    ...
    switch (applyGrowthDirectionToAxisDirection(
      ...
      case AxisDirection.up:
        ...
        break;
      case AxisDirection.down:
        offset += Offset(0, childMainAxisPosition(child as RenderBox));
        break;
      case AxisDirection.left:
        offset += Offset(
            geometry!.paintExtent -
        ...
        break;
      case AxisDirection.right:
        offset += Offset(childMainAxisPosition(child as RenderBox), 0);
        break;
    }
